...
if __name__ == '__main__':
    ...
    # pip_train = HybridTrainPipe(batch_size=TRAIN_BS, num_threads=NUM_WORKERS, device_id=device_id, data_dir=IMG_DIR+'/train', crop=CROP_SIZE, world_size=1, local_rank=0)
    # pip_test = HybridValPipe(batch_size=TEST_BS, num_threads=NUM_WORKERS, device_id=device_id, data_dir=IMG_DIR+'/val', crop=CROP_SIZE, size=VAL_SIZE, world_size=1, local_rank=0)
